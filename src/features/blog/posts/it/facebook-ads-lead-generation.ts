...
export const facebookAdsLeadGeneration: BlogPost = {
  ...
  keywords: [
    'facebook ads lead',
    'facebook ads leads',
    'facebook ads per generare lead',
  ...
  sections: [
    ...
    {
      type: 'h2',
      heading: 'Cos\'è un lead e perché non tutti valgono lo stesso',
      content:
    ...
    {
      type: 'h2',
      heading: 'La struttura di una campagna Facebook Ads per lead',
      content:
    ...
    {
      type: 'h3',
      heading: 'Obiettivo campagna: usa sempre "Contatti" o "Lead"',
      content:
    ...
    {
      type: 'h3',
      heading: 'Quanto dura il periodo di apprendimento?',
      content:
    ...
    {
      type: 'h2',
      heading: 'Come costruire il pubblico giusto per le tue Facebook Ads',
      content:
        'Il targeting è dove si vince o si perde una campagna. Meta ti offre tre opzioni principali.',
    },
    {
      type: 'h3',
      heading: '1. Pubblico per interessi (Interesse Targeting)',
      content:
    ...
    {
      type: 'h3',
      heading: '2. Pubblico personalizzato (Custom Audience)',
      content:
    ...
    {
      type: 'h3',
      heading: '3. Pubblico simile (Lookalike Audience)',
      content:
    ...
    {
      type: 'h2',
      heading: 'Budget: quanto spendere per iniziare con Facebook Ads',
      content:
    ...
    {
      type: 'h2',
      heading: 'Come misurare il successo di una campagna per lead',
      content:
    ...
    {
      type: 'h2',
      heading: 'Gli errori più comuni nelle Facebook Ads per lead generation',
      content:
    ...
    {
      type: 'h2',
      heading: 'Il ruolo del consulente Facebook Ads',
      content:
    ...
    {
      type: 'cta',
      heading: 'Vuoi che gestiamo le tue Facebook Ads?',
      content:
